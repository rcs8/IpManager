...
cucumber_1.defineSupportCode(function ({ Given, When, Then }) {
    Given(/^Given I am at the classes page$/, () => __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.browser.get("http://localhost:4200/");
        yield expect(protractor_1.browser.getTitle()).to.eventually.equal('IpmGui');
        yield protractor_1.$("a[name='classes']").click();
    }));
    Given(/^Given I have "([^\"]*)" registered as a student$/, (loginCin) => __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.$("a[name='cadastro']").click();
        yield protractor_1.$("input[name='loginCin']").sendKeys(loginCin);
        yield protractor_1.$("input[name='loginHuxley']").sendKeys(loginCin);
        yield protractor_1.$("input[name='senha']").sendKeys(loginCin);
    ...
    Given(/^Given I have the class with day "([^\"]*)" and description "([^\"]*)" in the list$/, (day, description) => __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.$("input[name='day']").sendKeys(day);
        yield protractor_1.$("input[name='description']").sendKeys(description);
        yield protractor_1.element(protractor_1.by.buttonText('Cadastrar')).click();
    ...
    Then(/^The student "([^\"]*)" will have "(\d*)" abscence$/, (loginCin, faltas) => __awaiter(this, void 0, void 0, function* () {
